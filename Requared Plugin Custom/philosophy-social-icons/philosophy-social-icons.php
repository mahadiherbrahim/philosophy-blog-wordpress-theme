<?php 
/*
Plugin Name: Philosophy Social Icons
Plugin URI:
Description: Philosophy Social Icons
Author Name: Ebrahim 
Author URI: http://ebrahim.xyz
Version: 1.0
License: GPLv2 or later
Text Domain: philosophy-social-icons
Domain Path: /languages/ 
*/
function philosophy_social_icons_load_texr_domain(){
	load_plugin_textdomain( 'philosophy', false, dirname(__FILE__)."/languages");
}
add_action( 'plugins_loaded', 'philosophy_social_icons_load_texr_domain' );



class PhilosophySocialIcons_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'Philosophy: Social Icons', 'philosophy' ), // Name
...
function philosophy_social_icons_widget() {
    register_widget( 'PhilosophySocialIcons_Widget');
}

add_action( 'widgets_init', 'philosophy_social_icons_widget' );
